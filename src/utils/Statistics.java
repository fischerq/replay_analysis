...
public class Statistics {
	public static void displayHistogram(String description, String axis, double[] data, int bins){
		...
		dataset.addSeries("Histogram",data, bins, min, max);
		...
		boolean urls = false; 
		JFreeChart chart = ChartFactory.createHistogram( description, axis, yaxis, 
				dataset, orientation, show, toolTips, urls);

		ChartWindow window = new ChartWindow(description, chart);
	}
	public static void displayScatter(String description, String series_name, String xAxis, String yAxis, double[][] data){
	...
	/*public static void displayHexbin(String description, String series_name, String xAxis, String yAxis, double[][] data){
		XYSeriesCollection dataset = new XYSeriesCollection();
	    XYSeries series = new XYSeries(series_name);
	    for (int i = 0; i < data.length; i++) {
	        series.add(data[i][0], data[i][1]);
